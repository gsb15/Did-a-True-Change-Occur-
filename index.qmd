...
-Traditional threshold-based approaches have limitations: Common approaches for evaluating athlete monitoring data include: 1) Smallest Worthwhile Change (SWC); 2) Typical Error of Measurement (TEM); 
3) Standard Error of Measurement (SEM); 4) Coefficient of Variation (CV). While these methods are widely used, they often lead to binary conclusions such as "changed" versus "not changed" and do not adequately communicate uncertainty surrounding the observed measurement. 
